...
if(s.name!=null&&s.name.indexOf('wuju-')==-1){ 
if(s.query.url){
...
window.history.pushState(null,null,'/?'+s.name+'&r='+Math.random().toString(36).substr(2,5));   
            ...
            r.modalStack = [], r.modalStackClearQueue = function () {
                ...
                i(".preloader-indicator-overlay").length > 0 || r.root.append('<div class="preloader-indicator-overlay"></div><div class="preloader-indicator-modal"><div class="wuju-load"><div class="wuju-loading"><i></i><i></i><i></i></div></div></div>')
                    ...
                    if (0 !== p.length) {
                        ...
                        if (!(T.disabled || e.hasClass("disabled") || k.hasClass("disabled"))) {
                            ...
                            "picker" === d ? (r._compiledTemplates.smartSelectToolbar || (r._compiledTemplates.smartSelectToolbar = s.compile(r.params.smartSelectToolbarTemplate || '<div class="toolbar {{#if toolbarTheme}}theme-{{toolbarTheme}}{{/if}}"><div class="toolbar-inner"><div class="left"></div><div class="right"><a href="#" class="link close-picker"><span>{{closeText}}</span></a></div></div></div>')), J = r._compiledTemplates.smartSelectToolbar({
                                ...
                                inPopup: "popup" === d,
                                inPage: "page" === d,
                                leftTemplate: "popup" === d ? (r.params.smartSelectPopupCloseTemplate || (y ? '<div class="left"><a href="#" class="link close-popup icon-only"><i class="icon icon-back"></i></a></div>' : '<div class="left"><a href="#" class="link close-popup"><i class="icon icon-back"></i><span>{{closeText}}</span></a></div>')).replace(/{{closeText}}/g, c) : (r.params.smartSelectBackTemplate || (y ? '<div class="left"><a href="#" class="back link icon-only"><i class="icon icon-back"></i></a></div>' : '<div class="left sliding"><a href="#" class="back link"><i class="wuju-icon wuju-fanhui2"></i></a></div>')).replace(/{{backText}}/g, h)
            ...
            var g = function (e) {
                ...
                var o = a.params.photoTemplate || '<div class="photo-browser-slide swiper-slide"><span class="swiper-zoom-container"><img src="{{js "this.url || this"}}"></span></div>',
                    ...
                    c = a.params.navbarTemplate || '<div class="navbar"><div class="navbar-inner"><div class="left sliding"><a href="#" class="link icon-only ' + ("popup" === e.type ? "close-popup" : "photo-browser-close-link") + ' {{#unless backLinkText}}icon-only{{/unless}} {{js "this.type === \'page\' ? \'back\' : \'\'"}}"><i class="wuju-icon wuju-fanhui2"></i></a></div><div class="right"><a href="#" class="link icon-only"></a></div></div></div>',
        ...
        }, LightSNS.$ = window.wuju, LightSNS.prototype.support = function () {
            return {
            ...
            var d = {};
            for (var c in a)
                if ("object" != typeof a[c] || null === a[c] || a[c].nodeType || a[c] === window || a[c] === document || "undefined" != typeof wuju && a[c] instanceof wuju || "undefined" != typeof jQuery && a[c] instanceof jQuery) d[c] = a[c];
                else {
                    d[c] = {};
            ...
            var g = g;
            if (void 0 !== g && "undefined" != typeof wuju && (g = wuju), (void 0 !== g || (g = "undefined" == typeof wuju ? window.wuju || window.Zepto || window.jQuery : wuju)) && (f.$ = g, f.currentBreakpoint = void 0, f.getActiveBreakpoint = function () {
