...
*/
var status=1;
function wuju_post_data(data_type,load_type,author_id,obj){


if($('.wuju-load-post').length==0&&load_type!='pull'){
if(!author_id){
$('.wuju-post-list-sns').prepend(wuju.loading_post);
}else{
$('.wuju-member-mine-post-list').prepend(wuju.loading_post);	
}
}
